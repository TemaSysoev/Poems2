...
//Text(misOut)
            ...
            case "Speaking":
                ...
                ZStack{
                   ...
                   /* HStack() {
                    ...
                    case "Слушаю...":
                        Text(LocalizedStringKey("Listening..."))
                    case "Ошибка":
                        Button(action: {
#if os(iOS)
                            if learningMode == "Speaking"{
        ...
        .onAppear{
            ...
            #if os(iOS)
            switch language{
            case "English": speechRec.speechRecognizer = SFSpeechRecognizer(locale: Locale(identifier: "en-us"))
            case "Russian": speechRec.speechRecognizer = SFSpeechRecognizer(locale: Locale(identifier: "ru-ru"))
            default:speechRec.speechRecognizer = SFSpeechRecognizer(locale: Locale(identifier: "en-us"))
            }
            #endif
        }
#if os(macOS)
