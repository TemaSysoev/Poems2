            ...
            ZStack(alignment: .center){
                            ...
                            VStack{
                                ...
                                if currentPage - 1 == fourLines.count / linesOnPage {
                                    Label(LocalizedStringKey("The end\nBack to beginning"), systemImage: "arrow.uturn.left")
                                        .font(fontName == "System" ? .system(size: CGFloat(fontSize), design: .serif):.custom(fontName, size: CGFloat(fontSize)))
                      ...
                      //  .animation(.spring(), value: self.offset)
                        ...
                        .rotation3DEffect(.degrees(Double(90*self.offset.width)/300), axis: (x: 0, y: 1, z: 0))
            ...
            VStack{
                ...
                HStack{
                    ...
                    HStack{
                        Text("\(currentPage)")
                        Text("of")
                        Text("\(fourLines.count / linesOnPage + 1)")
                    }
            ...
            .toolbar{
                                ...
                                ToolbarItem(){
                                    Button(action:{
                                        ...
                                        .popover(isPresented: $showingLearnView) { VStack{
                                            
                                            LearnView(language: language, author: author, title: title, inputText: inputText, fontName: fontName)
                                                .disabled(!subscribed)
                                            if !subscribed{
                                                
                                            SubscribeView(userAccentColor: "AccentColor")
                                            }
                                        }
                                        }
                                }
