...
class Store: ObservableObject {
    ...
    @Published private(set) var onTimePurchase: [Product]
    ...
    func requestProducts() async {
        do {
            ...
            var newOnTimePurchases: [Product] = []
            ...
            for product in storeProducts {
                ...
                case .consumable:
                    continue
                case .nonConsumable:
                    newOnTimePurchases.append(product)
                case .autoRenewable:
           ...
           onTimePurchase = sortByPrice(newOnTimePurchases)
